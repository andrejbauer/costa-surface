...
* a CSV file `costa.csv` with ready-made triangulations and surface normals,
* a PDF version of `Costa.nb`.

There is also a Python script that converts the CSV fiel to a partial PovRay [`mesh2`](http://www.povray.org/documentation/view/3.6.1/293/) element.
